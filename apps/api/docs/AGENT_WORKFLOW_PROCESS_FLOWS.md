...
| **Total Time** | 536.1 seconds (~9 minutes) |
| **Average per Document** | 29.8 seconds |
| **Quality Scores** | Range: 44-92, Average: 68.5 |
| **A-Grade Documents** | 2 (Market Research: 92, Section H: 90) |
| **Files Generated** | 72 files (18×4: MD, PDF, Eval MD, Eval PDF) |
...
├── Time: 84.6s
├── Avg Time: 21.2s/doc
└── Scores: 52, 75, 44, 68 (Avg: 59.8)

Phase 2 (Solicitation):
├── Documents: 7
├── Time: 225.5s
├── Avg Time: 32.2s/doc
└── Scores: 62, 61, 90, 62, 78, 58, 61 (Avg: 67.4)

Phase 3 (Evaluation & Award):
├── Documents: 7
├── Time: 112.9s
├── Avg Time: 16.1s/doc
└── Scores: 81, 74, 74, 74, 81, 73, 77 (Avg: 76.3)
```
...
**Based on:** Actual production run (536.1s, 18 documents, 72 files)
